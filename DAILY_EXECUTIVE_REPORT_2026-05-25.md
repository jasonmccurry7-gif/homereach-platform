...
- Medium: close-deal SMS now uses shared `sendSms()`, but live Twilio behavior still needs test-mode/sandbox validation before production send trust.
