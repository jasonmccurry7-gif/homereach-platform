...
- Added first-layer public read rate limiting to `/api/spots/resolve` and `/api/spots/availability` before service-role-backed catalog/availability lookups and created `PUBLIC_READ_ANTI_ABUSE_AUDIT.md`.
