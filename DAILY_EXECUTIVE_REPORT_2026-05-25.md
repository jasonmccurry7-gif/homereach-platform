...
- Escaped JSX apostrophes in static targeted, nonprofit, and inventory purchasing pages, reducing lint debt without changing rendered copy, form behavior, or checkout/provider flows.
...
- Latest static public-page lint cleanup: focused ESLint on targeted start/confirmed, nonprofit, and inventory-purchasing pages passed with 0 warnings/errors; focused web typecheck passed; full `pnpm test` passed with 209 tests across 33 files; full workspace typecheck passed across 5 packages; full web lint passed with 455 existing warnings and 0 errors; placeholder-env web build generated 247 static pages.
