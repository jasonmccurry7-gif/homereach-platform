      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700">
        ...
        <section className="border-2 border-blue-300 bg-blue-50 rounded-lg p-6">
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>Email: <a href={`mailto:${owner.domainEmail}`} className="text-blue-600 hover:underline">{owner.domainEmail}</a></li>
            <li>Phone: <a href={`tel:${owner.cellPhone}`} className="text-blue-600 hover:underline">{formatPhoneForDisplay(owner.cellPhone)}</a></li>
          </ul>
        ...
        <section>
          ...
          <p>By providing your email address, you consent to receive transactional and marketing emails from HomeReach related to our services. You may opt out of marketing emails at any time using the unsubscribe link in any email or by contacting <a href={`mailto:${owner.domainEmail}`} className="text-blue-600 hover:underline">{owner.domainEmail}</a>. Transactional emails (order confirmations, receipts, campaign status) will continue regardless of marketing opt-out status.</p>
        </section>
        ...
        <section>
          ...
          <div className="mt-2">
            ...
            <p>Phone: <a href={`tel:${owner.cellPhone}`} className="text-blue-600 hover:underline">{formatPhoneForDisplay(owner.cellPhone)}</a></p>
