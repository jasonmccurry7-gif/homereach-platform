...
export default async function OperationsCopilotDataPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold text-white">
              Procurement data plane
            </h1>
            <p className="mt-2 max-w-3xl text-sm text-neutral-300">
              This is the Copilot context layer: business rules, inventory,
              suppliers, quote intelligence, approvals, and active operating memory.
            </p>
          </div>
      ...
      <section className="rounded-lg border border-white/10 bg-white/[0.03] p-5">
        <h2 className="text-lg font-bold text-white">Inventory Radar</h2>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-lg border border-white/10 bg-white/[0.03] p-5">
          <h2 className="text-lg font-bold text-white">Quote Stream</h2>
          <div className="mt-4 space-y-3">
