...
const products = [
  ...
  },
  {
    ...
    body: "Capture, qualify, and route website leads into follow-up without making customers learn another tool.",
    cta: "Request Assistant",
    href: PRODUCT_OVERVIEW_PATHS.aiWebsiteAssistant,
    icon: Bot,
    accent: "blue" as const,
    meta: "Lead Capture",
  },
  {
    ...
    body: "City, service, campaign, and QR destination pages that help people find you and take action.",
    cta: "Get Local SEO Plan",
    href: PRODUCT_OVERVIEW_PATHS.localSeo,
    icon: Search,
    accent: "green" as const,
    meta: "SEO",
  },
  {
    ...
    body: "Review request campaigns, response drafts, and reputation visibility for local trust.",
    cta: "Improve Reviews",
    href: PRODUCT_OVERVIEW_PATHS.reputation,
    icon: Star,
  ...
  },
  {
    ...
    body: "SAM.gov opportunity tracking, bid/no-bid workflow, and human-approved bid room support.",
    cta: "Explore Contracts",
    href: PRODUCT_OVERVIEW_PATHS.governmentContracts,
    icon: Landmark,
