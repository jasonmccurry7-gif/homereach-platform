...
export const growthServiceModules: GrowthServiceModule[] = [
  ...
  },
  {
    ...
    title: "AI Web Assistant and Lead Capture",
    shortTitle: "AI Web Assistant",
    category: "lead_capture",
    status: "enhanced",
    publicExposure: "premium_service_page",
    publicPath: "/services/ai-website-assistant",
    adminPath: "/admin/ai-web-assistant",
    customerPath: "/ai-assistant",
    primaryCtaLabel: "Get a Free AI Assistant Demo",
    primaryCtaHref: "/services/ai-website-assistant#assistant-demo",
    headline: "Never miss a customer again.",
    outcome: "Answer website visitors, capture leads, route urgent requests, and summarize conversations instantly.",
    whoFor: "Local businesses that lose calls, miss after-hours website visitors, or need a simple front desk layer before a larger growth plan.",
    whatItDoes:
      "Answers approved business FAQs, captures name, phone, email, service need, location, urgency, and preferred contact method, routes urgent leads, drafts follow-up, and identifies reputation or local SEO opportunities from repeated questions.",
    ...
    enhancements: [
      "Define the AI assistant as a premium front desk and gateway product",
      "Route captured leads into follow-up, postcard, SEO, reputation, procurement, and AI agent offers",
      "Create per-business knowledge base, routing rules, setup preview, and embed-code workflow",
      "Keep outbound messaging, appointments, pricing promises, and public actions approval-first",
    ],
    executionActions: ["Capture lead", "Qualify inquiry", "Route urgent request", "Create follow-up task", "Draft response", "Recommend FAQ update"],
    eventTypes: ["assistant_demo_requested", "conversation_started", "faq_answered", "lead_captured", "urgent_handoff", "knowledge_gap_found"],
    dataEntities: [
      "ai_web_assistants",
      "ai_web_assistant_knowledge_items",
      "ai_web_assistant_conversations",
      "ai_web_assistant_leads",
      "ai_web_assistant_routing_rules",
      "ai_web_assistant_alerts",
      "sales_leads",
      "revenue_message_threads",
    ],
    aiAgents: ["Front Desk Agent", "Lead Capture Agent", "Routing Agent", "Reputation Agent", "Local SEO Insight Agent", "Follow-Up Agent"],
    approvalGates: ["human_review", "manual_send"],
    crossSells: ["Shared Postcards", "Targeted Campaigns", "Local SEO", "Reputation", "Procurement"],
    integrationGaps: [
      "Demo widget runtime exists, but production embed keys and domain-approved activation remain approval-gated.",
      "Calendar booking confirmation requires approved calendar rules.",
      "SMS follow-up must wait for Twilio A2P approval.",
    ],
    metrics: [
      { label: "Core promise", value: "24/7", detail: "Never miss a website visitor." },
      { label: "Lead path", value: "Captured", detail: "Name, contact, need, urgency, and next action." },
      { label: "Automation", value: "Supervised", detail: "Sensitive sends and promises stay approval-first." },
    ],
  },
  {
  ...
  },
  {
    ...
    publicPromise: "You get approval-ready local content drafts without staring at a blank page.",
    ...
    enhancements: [
      ...
      "Route public requests into AI Workforce with a required approval owner",
  ...
  },
  {
    ...
    title: "ContractOS Government Contract Support",
    shortTitle: "ContractOS",
    category: "government",
    status: "live",
    publicExposure: "premium_service_page",
    publicPath: "/contractos",
    adminPath: "/admin/contractos",
    customerPath: "/contractos/dashboard",
    primaryCtaLabel: "Open ContractOS",
    primaryCtaHref: "/contractos/dashboard",
    headline: "A simple, human-approved government contract operating system for small businesses.",
    outcome: "Find opportunities, understand requirements, decide bid/no-bid, price safely, organize documents, and manage pipeline value.",
    whoFor: "Small businesses and HomeReach clients pursuing government, subcontractor, or vendor opportunities.",
    whatItDoes:
    ...
    publicPromise: "ContractOS helps normal business owners understand public-sector opportunities without risky autonomous bidding.",
...
export const growthNextBuildSequence: GrowthNextBuildStep[] = [
  {
    phase: "1",
    title: "AI Website Assistant Activation Gate",
    objective: "Harden the demo-to-setup handoff, domain approval, client FAQ review, and activation checklist before live widgets.",
