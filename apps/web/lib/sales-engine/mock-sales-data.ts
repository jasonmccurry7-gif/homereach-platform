...
export const MOCK_SALES_LEADS: SalesLead[] = [
  ...
  // ── 1. HOT — asked pricing, wants to start ─────────────────────────────────
  {
    ...
    messages: [
      { id: "m-001-1", role: "ai",   channel: "sms", body: "Hi Mike, HomeReach helps roofing companies in Fairlawn stay visible with local homeowners without a huge ad budget. Want me to check if your category is still protected?", sentAt: hoursAgo(3), isRead: true, intentScore: 0 },
      ...
      { id: "m-001-3", role: "ai",   channel: "sms", body: "We build protected local postcard visibility for one roofing company in Fairlawn. The goal is simple recognition with homeowners before they need the work.", sentAt: hoursAgo(2.4), isRead: true, intentScore: 0 },
  ...
  // ── 2. HOT — asking how to get started ────────────────────────────────────
  {
    ...
    messages: [
      { id: "m-002-1", role: "ai",   channel: "sms", body: "Hi Derek, HomeReach is opening protected local visibility for electrical contractors in Akron. Want a quick look?", sentAt: hoursAgo(2), isRead: true, intentScore: 0 },
      ...
      { id: "m-002-3", role: "ai",   channel: "sms", body: "Akron is still open for electricians. I can send a simple coverage and cost breakdown so you can decide without guessing.", sentAt: hoursAgo(0.7), isRead: true, intentScore: 0 },
  ...
  // ── 3. WARM — curious, exploring ──────────────────────────────────────────
  {
    ...
    messages: [
      { id: "m-003-1", role: "ai",   channel: "sms", body: "Hi Carlos, HomeReach helps landscapers in Akron stay visible when homeowners start planning outdoor work. Want the simple coverage option?", sentAt: hoursAgo(5), isRead: true, intentScore: 0 },
  ...
  // ── 4. WARM — objection ────────────────────────────────────────────────────
  {
    ...
    messages: [
      { id: "m-004-1", role: "ai",   channel: "sms", body: "Hi Rachel, HomeReach can give one window and door company protected visibility in Barberton. Want to see the route and timing?", sentAt: hoursAgo(8), isRead: true, intentScore: 0 },
  ...
  // ── 5. COLD — no response, 1 follow-up sent ────────────────────────────────
  {
    ...
    messages: [
      { id: "m-005-1", role: "ai", channel: "sms", body: "Hi Steve, HomeReach is checking protected visibility for pest control companies in Tallmadge. Want the simple version?", sentAt: daysAgo(3), isRead: false, intentScore: 0 },
      { id: "m-005-2", role: "ai", channel: "sms", body: "Hi Steve, quick follow-up on the Tallmadge pest control visibility option. Want me to send the coverage and cost breakdown?", sentAt: daysAgo(2), isRead: false, intentScore: 0 },
    ],
    summary:         "No response after initial + 1 follow-up. Due for 2nd follow-up.",
    lastMessageAt:   daysAgo(2),
    lastMessageBody: "Hi Steve, quick follow-up on the Tallmadge pest control visibility option. Want me to send the coverage and cost breakdown?",
    lastMessageRole: "ai",
    followUpCount:   1,
  ...
  // ── 6. HUMAN ACTIVE — agent is in the convo ───────────────────────────────
  {
    ...
    messages: [
      { id: "m-006-1", role: "ai",         channel: "sms", body: "Hi Tom, HomeReach can help one painter in Cuyahoga Falls stay visible with nearby homeowners. Want to see the simple local plan?", sentAt: daysAgo(2), isRead: true, intentScore: 0 },
      ...
      { id: "m-006-6", role: "human_agent", channel: "sms", body: "Hi Tom, this is Jason from HomeReach. For Cuyahoga Falls, the anchor option is $399/mo and covers 2,500+ homes with protected category visibility. Want me to send the intake link?", sentAt: hoursAgo(20), isRead: true, intentScore: 0 },
    ],
  ...
  // ── 7. COLD — fresh, no reply yet ─────────────────────────────────────────
  {
    ...
    messages: [
      { id: "m-007-1", role: "ai", channel: "sms", body: "Hi Brad, HomeReach is checking protected visibility for garage door companies in Twinsburg. Want me to see if your category is still open?", sentAt: hoursAgo(6), isRead: false, intentScore: 0 },
    ],
    summary:         "Initial outreach sent. No reply yet.",
    lastMessageAt:   hoursAgo(6),
    lastMessageBody: "Hi Brad, HomeReach is checking protected visibility for garage door companies in Twinsburg.",
    lastMessageRole: "ai",
    followUpCount:   0,
  ...
  // ── 8. CLOSED WON ─────────────────────────────────────────────────────────
  {
    ...
    messages: [
      { id: "m-008-1", role: "ai",         channel: "sms", body: "Hi Patricia, HomeReach can give one insurance agency protected visibility in Akron. Want the simple coverage and pricing link?", sentAt: daysAgo(6), isRead: true, intentScore: 0 },
