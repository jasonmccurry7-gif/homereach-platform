...
const ENV_SPECS: EnvSpec[] = [
  ...
  { key: "ENABLE_META_CONNECTED_PUBLISHING", required: false, productionOnly: false, validValues: ["true", "false"] },
  { key: "ENABLE_META_AUTO_PUBLISHING", required: false, productionOnly: false, validValues: ["true", "false"] },
  ...
  { key: "META_APP_ID", required: false, productionOnly: false },
  { key: "META_APP_SECRET", required: false, productionOnly: false },
  { key: "META_REDIRECT_URI", required: false, productionOnly: false },
  { key: "META_TOKEN_ENCRYPTION_KEY", required: false, productionOnly: false },
  { key: "META_GRAPH_API_VERSION", required: false, productionOnly: false },
  { key: "META_OAUTH_SCOPES", required: false, productionOnly: false },
