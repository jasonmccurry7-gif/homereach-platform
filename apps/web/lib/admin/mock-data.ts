    ...
    messages: [
      {
        ...
        direction: "outbound",
        channel: "sms",
        body: "Hi Mike, this is Jason from HomeReach. We help local businesses stay visible with homeowners in Medina without adding another complicated marketing system. Do you have 2 minutes to see the simple version?",
      ...
      },
      {
        ...
        direction: "outbound",
        channel: "sms",
        body: "We protect one business per category in each market, so your Medina plumbing message has room to be remembered. Pricing starts at $299/mo. Want the full breakdown?",
    ...
    messages: [
      {
        ...
        direction: "inbound",
        channel: "email",
        body: "Hi, I found HomeReach online and I am interested in a simpler way to stay visible with local homeowners. I am a chiropractor in Hudson. Can we schedule a call to go over design options and pricing?",
    ...
    messages: [
      {
        ...
        direction: "outbound",
        channel: "sms",
        body: "Hi Angela, Jason from HomeReach here. I saw you filled out the form. The Hudson realtor visibility option is still available, and I can walk you through coverage, pricing, and next step in one quick call. Does today work?",
