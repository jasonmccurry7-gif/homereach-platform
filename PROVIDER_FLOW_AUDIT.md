...
20. Public `/api/spots/resolve`, `/api/spots/availability`, and `/api/political/routes/coverage` service-role-backed read lookups now have first-layer in-process rate limits before catalog, availability, or political route coverage reads.
